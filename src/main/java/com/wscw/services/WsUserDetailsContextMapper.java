...
import com.wscw.entities.WsLdapUserDetails;
import com.wscw.entities.WscwSysUser;

@SpringComponent
public class WsUserDetailsContextMapper implements UserDetailsContextMapper {
	@Autowired
	...
	public UserDetails mapUserFromContext(DirContextOperations ctx, String username, Collection<? extends GrantedAuthority> arg2) {
		WscwSysUser sysUser = sysUserService.findByUserid(username.toLowerCase());
		WsLdapUserDetails userDetails = new WsLdapUserDetails();
		if (sysUser == null) {
