 ...
 */
@Embeddable
public class WscwSysUserrolePK implements Serializable {
	...
	public WscwSysUserrolePK() {
	}
	
	public WscwSysUserrolePK(String iduser, long idrole) {	
		this.iduser = iduser;
		this.idrole = idrole;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof WscwSysUserrolePK)) {
			return false;
		}
		WscwSysUserrolePK castOther = (WscwSysUserrolePK)other;
		return 
