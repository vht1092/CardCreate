...
import com.wscw.ReloadAutoComponent;
import com.wscw.ReloadComponent;
import com.wscw.SecurityUtils;
import com.wscw.WsTabType;
import com.wscw.components.WsCardCreation;
import com.wscw.services.SysTxnService;
...
public class MainView extends HorizontalLayout implements View {
	...
	@PostConstruct
	void init() {
		Page.getCurrent().setTitle("Card create");
		setSizeFull();
...
//			}
		...
		tabsheet.addTab(new WsCardCreation(), WsCardCreation.CAPTION);
		tree = new Tree();
	...
	private void addNewTab(final String itemName) {
		try {
			final Class<? extends Component> tabType = WsTabType.getTabType(itemName).getClassComponent();
