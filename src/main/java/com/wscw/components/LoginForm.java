...
public class LoginForm extends VerticalLayout {
	...
	public LoginForm(final LoginCallback callback) {
		...
		final Label lbHeader = new Label(
				...
				+ " <span style=\"font-size:24px; color:#ffffff;font-weight: bold;text-transform: uppercase;\">CARD CREATION</span></div>");
		...
		final Label lbFireFox = new Label("Ứng dụng dùng tốt trên <img class=\"v-icon\" src=\'" + urlServer + "/VAADIN/themes/mytheme/img/rsz_mozilla-firefox-icon.png'></img>"
				+ "<img class=\"v-icon\" src=\'" + urlServer + "/VAADIN/themes/mytheme/img/rsz_internet-chrome-icon.png'></img><br/>Bản quyền © 2020 Ngân Hàng TMCP SCB. Version 1.0");
