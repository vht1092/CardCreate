...
import com.wscw.ldap.authen.CustomActiveDirectoryLdapAuthenticationProvider;
import com.wscw.services.WsUserDetailsContextMapper;
...
public class SecurityConfig extends GlobalMethodSecurityConfiguration {
	...
	@Autowired
	private WsUserDetailsContextMapper gstsUserDetailsContextMapper;
	...
	public ActiveDirectoryLdapAuthenticationProvider activeDirectoryLdapAuthenticationProvider() {
		...
		provider.setUserDetailsContextMapper(gstsUserDetailsContextMapper);
		return provider;
	}
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		// DEVELOP
		// auth.inMemoryAuthentication().withUser("huyennt").password("huyennt").roles("MAN").and().withUser("gsts").password("gsts").roles("OFF");
		// PRODUCTION
